...
@Component({
  ...
  imports: [IonContent, CommonModule, FormsModule, IonList, IonIcon, RouterLink, IonItem, IonButton, ReactiveFormsModule, IonInput, IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle]
})
