  ...
  import { IonContent, IonHeader, IonTitle, IonToolbar, IonTab, IonTabs, IonTabBar, IonSearchbar, IonTabButton, IonIcon, ToastController, IonTextarea, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonInput, IonSelect, IonSelectOption, IonButton, IonImg, IonAlert, AlertController} from '@ionic/angular/standalone';
  import { addIcons } from 'ionicons';
  import { addOutline, homeOutline, personCircle, trashOutline, createOutline, ellipsisVerticalOutline, pencilSharp, lockClosedOutline } from 'ionicons/icons';
  ...
  @Component({
    ...
    standalone: true,
    imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonTab, IonTabs, IonTabBar, IonTextarea, IonTabButton, IonIcon, IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonInput, IonSelect, IonSelectOption, ReactiveFormsModule, IonButton, IonImg, IonAlert, IonImg, RouterLink, IonTextarea, IonSearchbar]
  })
  export class MainPage implements OnInit {
    ...
    constructor(private toastController:ToastController, private alertController:AlertController) { 
      addIcons({ addOutline, homeOutline, personCircle, trashOutline, createOutline, ellipsisVerticalOutline, pencilSharp, lockClosedOutline });
      this.obterListaTarefasPublicas()
    }
